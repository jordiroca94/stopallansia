    ...
    <div className="pt-header">
      <Container>
        <Grid customGap="gap-4" className="pb-6 lg:pb-12">
          ...
          <h2 className="text-2xl lg:text-4xl font-semibold col-span-full">
            How to reserve your spot
          </h2>
          <div className="col-span-4 lg:col-span-8 flex flex-col gap-3 text-base text-justify">
            ...
            <p>
              Your booking will be confirmed after we receive your participation
              contribution.
            </p>
            <p>
          ...
          <div className="aspect-[5/6] bg-black col-span-4 lg:col-start-9 text-white flex items-center justify-center">
            PICTURE HERE
          </div>
        </Grid>
      </Container>
